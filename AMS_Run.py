...
def manually_fill():
    ...
    def fill_attendance():
        ...
        #         host='localhost', user='root', password='abcd@1234', db='manually_fill_attendance')
        ...
        try:
            ...
            table_name = DB_table_name  # Replace with your table name
        ...
        if subb == '':
            ...
            def enter_data_DB():
                ...
                # Establish a connection to the MySQL database
                            ...
                            # Now enter attendance data into the table
                    insert_data = f"INSERT INTO {table_name} (ID,ENROLLMENT, NAME, DATE, TIME) VALUES (0,%s, %s, %s, %s)"
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/be20c/OneDrive/Desktop/Face-Recognition-Attendance-System/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\be20c\OneDrive\Desktop\Face-Recognition-Attendance-System\Attendance\Manually Attendance"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                #     global cursor
                #     connection = pymysql.connect(
                #         host='localhost', user='root', password='abcd@1234', db='face_reco_fill')
                #     cursor = connection.cursor()
                # except Exception as e:
                #     print(e)
            ...
            try:
                ...
                # Now enter attendance data into the table
                insert_data = f"INSERT INTO {table_name} (ENROLLMENT, NAME, DATE, TIME) VALUES (%s, %s, %s, %s)"
                values = (str(Id), str(aa), str(date), str(timeStamp))
                cursor.execute(insert_data, values)            
                connection.commit()
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/be20c/OneDrive/Desktop/Face-Recognition-Attendance-System/' + fileName
